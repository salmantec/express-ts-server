...
router.post('/register', (req, res) => {
    try {
        ...
        if (req.body.role === 'student') {
            user = new Student(req.body.name, req.body.email, req.body.password);
        } else {
            user = new Teacher(req.body.name, req.body.email, req.body.password);
        }
        user.register()
...
router.get('/students/:email/assignments', (req, res) => {
    try {
        ...
        let assignments: Object = student.getAssignments();
